// 2022/04/28 html:innerText/textContentを追加
...
let html =
{
	...
	//---------------------------------------------------------------------
	{
		...
		switch( html.param[name].type )
		{
			...
			case "innerText":	val = html.getById_textText( name, val );			break;
			case "textContent":	val = html.getById_textContent( name, val );		break;
	...
	//---------------------------------------------------------------------
	{
		if ( html.param[name].req )
		{
			...
			switch( html.param[name].type )
			{
				...
				case "innerText":	html.setById_textText( name, val );			break;
				case "textContent":	html.setById_textContent( name, val );		break;
	...
	//---------------------------------------------------------------------
	"getById_textContent":function( name, val )
	//---------------------------------------------------------------------
	{
		if ( document.getElementById( name ) )
		{
	...
	//---------------------------------------------------------------------
	"setById_textContent":function( name, val  )
	//---------------------------------------------------------------------
	{
		if ( document.getElementById( name ) )
		{
	...
	//---------------------------------------------------------------------
	"getById_innerText":function( name, val )
	//---------------------------------------------------------------------
	{
		if ( document.getElementById( name ) )
		{
	...
	//---------------------------------------------------------------------
	"setById_innerText":function( name, val  )	//innerText はテキストがレンダリングされる表示
	//---------------------------------------------------------------------
	{
		if ( document.getElementById( name ) )
		{
