...
//-----------------------------------------------------------------------------
function print( tx, ty, str, col = "#888" )
//-----------------------------------------------------------------------------
{
	ctx.beginPath();
...
//-----------------------------------------------------------------------------
{
	...
	//--
	drawCanvas( html_canvas, g_buf, "A" );
//print(10,10,"aaa");
...
//-----------------------------------------------------------------------------
{
	...
	g_buf = live( g_buf, g_reso_x, g_reso_y );
...
//-----------------------------------------------------------------------------
{
	...
	{
		//ランダム
		for ( let i = 0 ; i < g_reso_x*g_reso_y ; i++ )
		{
			if ( rand(1) > 0.5 ) 
			{
				g_seed[i] = 1;
