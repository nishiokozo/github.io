...
//-----------------------------------------------------------------------------
{
	...
	//-------------------------------------------------------------------------
	{
		...
		gra.color(1,1,1);
									...
									function pvc_drawVec( p, v, R )
									{
										g_pvc.push({p:vcopy2(p), q:vadd2(p,v), r:1,g:0,b:0, name:""	, pt:""} );

										let n = vmuls2(R,dot2(R,v));
										let t = vsub2( v, n );

										g_pvc.push({p:vcopy2(p), q:vadd2(p,n), r:0,g:0,b:1, name:""	, pt:""} );
										g_pvc.push({p:vcopy2(p), q:vadd2(p,t), r:0,g:0,b:1, name:""	, pt:""} );
										g_pvc.push({p:vadd2(p,v), q:vadd2(p,n), r:0,g:0,b:0, name:""	, pt:"hasen1"} );
										g_pvc.push({p:vadd2(p,v), q:vadd2(p,t), r:0,g:0,b:0, name:""	, pt:"hasen1"} );
									}
									function line_drawVec( p, v, R )
									{
										g_line.push({p:vcopy2(p), q:vadd2(p,v), r:1,g:0,b:0, name:""	, pt:""} );

										let n = vmuls2(R,dot2(R,v));
										let t = vsub2( v, n );

										g_line.push({p:vcopy2(p), q:vadd2(p,n), r:0,g:0,b:1, name:""	, pt:""} );
										g_line.push({p:vcopy2(p), q:vadd2(p,t), r:0,g:0,b:1, name:""	, pt:""} );
										g_line.push({p:vadd2(p,v), q:vadd2(p,n), r:0,g:0,b:0, name:""	, pt:"hasen1"} );
										g_line.push({p:vadd2(p,v), q:vadd2(p,t), r:0,g:0,b:0, name:""	, pt:"hasen1"} );
									}
...
//				g_line.push({p:vcopy2(p), q:vadd2(p,n), r:0,g:0,b:0, name:""	, pt:""} );
//				g_line.push({p:vadd2(p,v), q:vadd2(p,n), r:0,g:0,b:0, name:""	, pt:"hasen"} );
...
if(lab.req=='pause')
		...
		{//運動量ベクトル表示
			...
			{// 法線描画
				...
				let p = b0.p;
				let v = b0.v;
				let N = normalize2(vsub2( b1.p, b0.p ));
				let n = vmuls2( N, dot2(N,v) );
...
//					let v = length2(balls[0].v) + length2(balls[1].v);
//					gra.color(1,1,1);	gra.print( "mv=" + strfloat(v	,2,7) );
		}
		else
		if ( lab.debug_d ) 
		{
