"use strict";
	...
	var	r		=	"([A-E|H|L])";			//A B C D E F H L
	var	n		=	"([0-9A-Za-z]+)";	//Numeric
	var	b		=	n;
	var	d		=	"([\\+|\\-][0-9A-Za-z]+)";	//Numeric
	var	nn		=	Symbol;//"([0-9|A-Z]+)";
	var	e		=	n						//Numeric
	var	dd		=	"(BC|DE|HL|SP)";		//
	var	qq		=	"(BC|DE|HL|AF)";		//
	var	ss		=	"(BC|DE|HL|SP)";		//
	...
	[
		...
		,new RegExp(	"^ADD "		+"A"				+","+"\\(HL\\)"			+"$")	//58	ADD A,(HL)
		...
		,new RegExp(	"^OUTIR"												+"$")	//200	OUTIR
		,new RegExp(	"^OUTD"													+"$")	//201	OUTD
		,new RegExp(	"^OUTDR"												+"$")	//202	OUTDR

		,new RegExp(	"^"		+Symbol											+"$")	// 0	ADDRESS:
		,new RegExp(	"^"		+Symbol+ " EQU " + n							+"$")	// 0	ADDRESS:
		...
		for ( var i=0 ; i < tblStr.length ; i++ )
		{
			...
			for ( p ; p<tblOpc.length ; p++ )
			{
				...
				if ( tbl!=null )
				{
					...
					case 161:	//	BIT b,r
						write_hex1( 0xCB );
						write_hex1( 0b01000000|(g_b[o1]<<3)|g_b[o2] );
						valFind=Find.OK;
						break;
					case 162:	//	BIT b,(HL)
						write_hex1( 0xCB );
					...
					case 189:	//	RETN
						...
						break;
					case 190:	//	RST p
						write_hex1( 0b11000111|(g_p[o1]<<3) );
						valFind=Find.OK;
						break;
					case 191:	//	IN A,(n)
						write_hex1( 0xDB );
