...
//-----------------------------------------------------------------------------
{
	...
	let buf = live( buf_life, g_reso_x, g_reso_y );
		...
		if ( x >= 0 && x < g_reso_x && y >= 0 && y < g_reso_y )
		{
			if ( g_buf_land[ g_reso_x*y+x ] == 0 )
			{
				if ( flgBold)
				{
					...
					g_bufA[ round2d(x  ,y  ,g_reso_x,g_reso_y)	] = g_penCol*2;
					g_bufA[ round2d(w  ,y  ,g_reso_x,g_reso_y)	] = g_penCol*1;

					g_bufA[ round2d(x  ,y+1,g_reso_x,g_reso_y)	] = g_penCol*2;
					g_bufA[ round2d(w  ,y+1,g_reso_x,g_reso_y)	] = g_penCol*1;

					g_bufA[ round2d(x+1,y  ,g_reso_x,g_reso_y)	] = g_penCol*2;
					g_bufA[ round2d(w-1,y  ,g_reso_x,g_reso_y)	] = g_penCol*1;

					g_bufA[ round2d(x+1,y+1,g_reso_x,g_reso_y)	] = g_penCol*2;
					g_bufA[ round2d(w-1,y+1,g_reso_x,g_reso_y)	] = g_penCol*1;
				}
				else
				{
					g_bufA[ g_reso_x*y+x              ] = g_penCol*2;
					g_bufA[ g_reso_x*y+(g_reso_x-x-1) ] = g_penCol*1;
...
//-----------------------------------------------------------------------------
{
	...
	g_reso_x =  document.getElementById( "html_reso" ).value * 1.0;
	g_reso_y = g_reso_x/2;
	init_land();
